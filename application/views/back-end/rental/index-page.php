                     ...
                     <div class="col-md-4 text-right">
                        <div class="card-footer bg-transparent" style="margin-top: -15px;">
                           <div class="text-center">
                              <a href="<?= site_url('admin/rental/create') ?>" class="btn btn-outline-success btn-sm align-middle me-2" title="Vehicle" style="float: right;">
                     ...
                     <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                        <thead class="table-light">
                           <tr>
                              ...
                              <th class="align-middle">Fare Base Price</th>
                              <th class="align-middle">Fare General price</th>
                        ...
                        <tbody>
                           <?php foreach($rentalfares->result() as $key => $data) { ?>
                           <tr>
                              ...
                              <td><?= $data->fare_per_minutes ?></td>
                            
                              <td>
                                 <div class="d-flex gap-3">
                                    <a href="<?= site_url('admin/rental/update/'.$data->fare_id) ?>" class="btn btn-outline-secondary btn-sm"><i class="mdi mdi-pencil font-size-13"></i></a>
                                    <a href="<?= site_url('admin/rental/remove/'.$data->fare_id) ?>" class="btn btn-outline-danger btn-sm" onclick="return confirm('Are you sure you want to remove this fare ?');"><i class="mdi mdi-delete font-size-13"></i></a>
                                 </div>
                              </td>
                           </tr>
                           <?php } ?>
