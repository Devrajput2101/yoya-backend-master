      ...
      <div class="row">
         ...
         <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
               <h4 class="mb-sm-0 font-size-18">Vehicle Transport Fare</h4>
               <div class="page-title-right">
                  <ol class="breadcrumb m-0">
                     <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboard</a></li>
                     <li class="breadcrumb-item active">Vehicle Transport Fare Create</li>
                  </ol>
               </div>
            </div>
         </div>
         ...
         <div class="col-12">
            <div class="card">
               <div class="card-body">
                  <div class="row mb-4">
                     <div class="col-md-8">
                        <h4 class="card-title">Vehicle Transport Fare Create</h4>
                     </div>
                     <div class="col-md-4 text-right">
                        <div class="card-footer bg-transparent" style="margin-top: -15px;">
                           <div class="text-center">
                              ...
                              <i class="bx bx-arrow-back"></i>Vehicle Transport fare
                              </a>
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="row mb-2 mt-2">
                     <div class="col-md-6">
                        ...
                        <div class="input-group" id="fare_time_free">
                           <input type="text" class="form-control" placeholder="Fare Time Free" name="fare_time_free" value="<?= set_value('fare_time_free') ?>">
                        </div>
                        <?= form_error('fare_time_free', '<div class="error">', '</div>'); ?>
                     </div>
                     <div class="col-md-6">
                        <label>Fare Business Price</label>
                        <div class="input-group" id="fare_business_price">
                           <input type="text" class="form-control" placeholder="Per Minutes" name="fare_business_price" value="<?= set_value('fare_business_price') ?>">
                        </div>
                  ...
                  <div class="row mb-2 mt-2">
                     <div class="col-md-6">
                        ...
                        <div class="input-group" id="fare_night_price">
                           <input type="text" class="form-control" placeholder="Per Minutes" name="fare_night_price" value="<?= set_value('fare_night_price') ?>">
                        </div>
                     ...
                     <div class="col-md-6">
                        ...
                        <div class="input-group" id="fare_extra_waiting_price">
                           <input type="text" class="form-control" placeholder="Fare Extra Waiting Price" name="fare_extra_waiting_price" value="<?= set_value('fare_extra_waiting_price') ?>">
                        </div>
                  ...
                  <div class="row mb-2 mt-2">
                     <div class="col-md-6">
                        ...
                        <div class="input-group" id="fare_stop_price">
                           <input type="text" class="form-control" placeholder="Fare Stop Price" name="fare_stop_price" value="<?= set_value('fare_stop_price') ?>">
                        </div>
                        <?= form_error('fare_stop_price', '<div class="error">', '</div>'); ?>
                     </div>
                     <div class="col-md-6">
                        <label>Fare commission Price</label>
                        <div class="input-group" id="fare_commission">
                           <input type="text" class="form-control" placeholder="Fare commission Price" name="fare_commission" value="<?= set_value('fare_night_price') ?>">
                        </div>
